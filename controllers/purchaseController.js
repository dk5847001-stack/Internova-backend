...
exports.downloadOfferLetter = async (req, res) => {
  try {
    ...
    const bodyText1 = `We are pleased to confirm your enrollment in the Internship Programs "${internshipTitle}" offered by Internova. Based on your successful registration and payment confirmation, you have been granted offer for a duration of ${
